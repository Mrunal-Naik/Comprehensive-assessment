...
import pageObjects.NavigatePO;
import resource.Browser;

public class Navigate extends Browser {
	public static Logger Log = LogManager.getLogger(Navigate.class.getName());
	@Test
	public void navigate() throws IOException, InterruptedException {
		driver = initializebrowser();
		driver.get(prop.getProperty("url"));
	    Actions action = new Actions(driver);
	    NavigatePO po = new NavigatePO(driver);
